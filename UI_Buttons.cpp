...
void onButtonEvent(hId id, ButtonEventType type)
{
	...
	if (type == ButtonEventType::Pressed) { // Pressed
		...
		if (mode == 0 || mode == 1) {
			...
			if (id == "btn12"){ target[1] += step3;sendtoMotionManager();}
			if (id == "btn13"){ target[1] += step2;sendtoMotionManager();}
			if (id == "btn14"){ target[1] += step1;sendtoMotionManager();}
			if (id == "btn15"){ target[1] -= step1;sendtoMotionManager();}
			if (id == "btn16"){ target[1] -= step2;sendtoMotionManager();}
			if (id == "btn17"){ target[1] -= step3;sendtoMotionManager();}
			if (id == "btn18"){ target[1] -= step4;sendtoMotionManager();}

			if (id == "btn21"){ target[2] += step4;sendtoMotionManager();}
			if (id == "btn22"){ target[2] += step3;sendtoMotionManager();}
			if (id == "btn23"){ target[2] += step2;sendtoMotionManager();}
			if (id == "btn24"){ target[2] += step1;sendtoMotionManager();}
			if (id == "btn25"){ target[2] -= step1;sendtoMotionManager();}
			if (id == "btn26"){ target[2] -= step2;sendtoMotionManager();}
			if (id == "btn27"){ target[2] -= step3;sendtoMotionManager();}
			if (id == "btn28"){ target[2] -= step4;sendtoMotionManager();}

			if (id == "btn31"){ target[3] += step4;sendtoMotionManager();}
			if (id == "btn32"){ target[3] += step3;sendtoMotionManager();}
			if (id == "btn33"){ target[3] += step2;sendtoMotionManager();}
			if (id == "btn34"){ target[3] += step1;sendtoMotionManager();}
			if (id == "btn35"){ target[3] -= step1;sendtoMotionManager();}
			if (id == "btn36"){ target[3] -= step2;sendtoMotionManager();}
			if (id == "btn37"){ target[3] -= step3;sendtoMotionManager();}
			if (id == "btn38"){ target[3] -= step4;sendtoMotionManager();}

			if (id == "btn51"){ target[5] += step4;sendtoMotionManager();}
			if (id == "btn52"){ target[5] += step3;sendtoMotionManager();}
			if (id == "btn53"){ target[5] += step2;sendtoMotionManager();}
			if (id == "btn54"){ target[5] += step1;sendtoMotionManager();}
			if (id == "btn55"){ target[5] -= step1;sendtoMotionManager();}
			if (id == "btn56"){ target[5] -= step2;sendtoMotionManager();}
			if (id == "btn57"){ target[5] -= step3;sendtoMotionManager();}
			if (id == "btn58"){ target[5] -= step4;sendtoMotionManager();}

			if (id == "btn61"){ target[6] += step4;sendtoMotionManager();}
			if (id == "btn62"){ target[6] += step3;sendtoMotionManager();}
			if (id == "btn63"){ target[6] += step2;sendtoMotionManager();}
			if (id == "btn64"){ target[6] += step1;sendtoMotionManager();}
			if (id == "btn65"){ target[6] -= step1;sendtoMotionManager();}
			if (id == "btn66"){ target[6] -= step2;sendtoMotionManager();}
			if (id == "btn67"){ target[6] -= step3;sendtoMotionManager();}
			if (id == "btn68"){ target[6] -= step4;sendtoMotionManager();}
		}
		/*else
		{
